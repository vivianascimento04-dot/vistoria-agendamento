  ...
  function isDiaBloqueado(ds) {
    ...
    if (especiaisNaData.length > 0) {
      const regraEmp = empreendimentoSel
        ...
        : null
      const regraTodos = especiaisNaData.find(d => !d.empreendimento || d.empreendimento === 'todos')
          ...
          <div style={{maxWidth:'560px',margin:'0 auto'}}>
            <div style={{background:'#fff',borderRadius:'16px',padding:'1.5rem',boxShadow:'0 8px 32px rgba(27,47,126,0.10)'}}>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
                {empreendimentos.length === 0 && <p style={{color:'#9ca3af',fontSize:'13px',textAlign:'center',padding:'2rem'}}>Nenhum empreendimento disponivel.</p>}
