      ...
      <tr><td style="background:#ffffff;padding:36px 32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9ff;border-radius:12px;border:1px solid #e0e5f5;margin-bottom:24px;">
          ...
          <tr><td style="padding:4px 24px 16px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:10px 0;border-bottom:1px solid #eef0f8;width:40%;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Data</p></td>
              ...
              <td style="padding:10px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;font-weight:600;color:#374151;margin:0;">${apartamento}</p></td></tr>
              <tr><td style="padding:10px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Acompanhante</p></td>
              <td style="padding:10px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;font-weight:600;color:#374151;margin:0;">${nome_acompanhante}</p></td></tr>
              <tr><td style="padding:10px 0;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">CPF Acompanhante</p></td>
              <td style="padding:10px 0;"><p style="font-size:14px;color:#374151;margin:0;">${cpf_acompanhante}</p></td></tr>
            </table>
          </td></tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff8e1;border-radius:10px;border-left:4px solid #f59e0b;margin-bottom:24px;">
          <tr><td style="padding:14px 18px;">
            ...
            <p style="font-size:13px;color:#92400e;margin:0;line-height:1.5;">Em caso de duvidas ou necessidade de alteracao, entre em contato com o Relacionamento.</p>
          </td></tr>
        </table>
      </td></tr>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4f8;padding:30px 0;">
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);">
      ...
      <tr><td style="background:#1e40af;padding:12px 32px;text-align:center;">
      ...
      <tr><td style="background:#ffffff;padding:36px 32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9ff;border-radius:12px;border:1px solid #e0e5f5;margin-bottom:20px;">
          ...
          <tr><td style="padding:4px 24px 16px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:9px 0;border-bottom:1px solid #eef0f8;width:35%;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Nome</p></td>
              <td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;font-weight:700;color:#111;margin:0;">${nome}</p></td></tr>
              <tr><td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">CPF</p></td>
              <td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;color:#374151;margin:0;">${cpf}</p></td></tr>
              <tr><td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">E-mail</p></td>
              <td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;color:#1B2F7E;font-weight:600;margin:0;">${email}</p></td></tr>
              <tr><td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Telefone</p></td>
              <td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;color:#374151;margin:0;">${telefone}</p></td></tr>
              <tr><td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Acompanhante</p></td>
              <td style="padding:9px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:14px;color:#374151;margin:0;">${nome_acompanhante}</p></td></tr>
              <tr><td style="padding:9px 0;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">CPF Acompanhante</p></td>
              <td style="padding:9px 0;"><p style="font-size:14px;color:#374151;margin:0;">${cpf_acompanhante}</p></td></tr>
            </table>
          </td></tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" style="border-radius:12px;border:2px solid #1B2F7E;margin-bottom:20px;">
          ...
          <tr><td style="padding:4px 24px 16px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:10px 0;border-bottom:1px solid #eef0f8;width:35%;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Data</p></td>
              <td style="padding:10px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:15px;font-weight:700;color:#1B2F7E;margin:0;">${dataCapitalizada}</p></td></tr>
              <tr><td style="padding:10px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:0;">Horario</p></td>
              <td style="padding:10px 0;border-bottom:1px solid #eef0f8;"><p style="font-size:15px;font-weight:700;color:#1B2F7E;margin:0;">${horario}</p></td></tr>
              ...
              <td style="padding:10px 0;"><p style="font-size:14px;font-weight:600;color:#374151;margin:0;">${apartamento}</p></td></tr>
            </table>
          </td></tr>
        </table>
      </td></tr>
